    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <input id="default-color" type="text" class="form-control input-lg" value="#00a9ae"/>
                </div>
            </div>
        </div>  
        <!-- End col -->
        ...
        <div class="col-lg-6">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <h6 class="card-subtitle">Most simple example, with any options or color information.</h6>
                    <input id="rgb-color" type="text" class="form-control input-lg" value="#00a9ae"/>
                </div>
            </div>
        </div>  
        <!-- End col -->
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <div id="initial-color" class="input-group" title="Using input value">
                      <input type="text" class="form-control input-lg" value="#00a9ae"/>
