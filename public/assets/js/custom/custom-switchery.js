...
!function($) {
  "use strict";
      ...
      var switchery = new Switchery(primary, { color: '#00a9ae' });
      ...
      var switchery = new Switchery(primary_small, { color: '#00a9ae', size: 'small' });
      ...
      var switchery = new Switchery(primary_large, { color: '#00a9ae', size: 'large' });
      ...
      var switchery = new Switchery(primary_multicolor, { color: '#00a9ae', jackColor: '#dbe5fd' });
      ...
      var switchery = new Switchery(primary_multicolor_on_off, { color: '#00a9ae', secondaryColor: '#949ca9', jackColor: '#dbe5fd', jackSecondaryColor: '#e9eaed' });
      var secondary_multicolor_on_off = document.querySelector('.js-switch-secondary-multicolor-on-off');
      var switchery = new Switchery(secondary_multicolor_on_off, { color: '#96a3b6', secondaryColor: '#00a9ae', jackColor: '#e9eaed', jackSecondaryColor: '#dbe5fd' });
