                ...
                <div class="card-body">
                    <div class="row mb-5">
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            ...
                            <h6>Order Placed</h6>
                            <p class="mb-0">15/02/2020 at 03:20 PM</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            <div class="order-primary-detail mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-xl-6 ">
                            ...
                            <p>525 Marin Drive, New Street,<br/> Royal Park, <br/> Florida-12345</p>
                                ...
                                <table class="table table-borderless text-right">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-black f-w-7 font-18">$1410.00</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="order-primary-detail">
                        ...
                        <p class="mb-0">Invoice No : #96325</p>
                        <p class="mb-0">Seller GST : 5421WESDXC009</p>
...
<div class="footerbar">
    <footer class="footer">
        <p class="mb-0">© 2023 -- Log Book App System.</p>
    </footer>
</div>
<!-- End Footerbar -->
</div>
