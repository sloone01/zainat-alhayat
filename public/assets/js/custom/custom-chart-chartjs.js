        ...
        var lineChart = new Chart(linechartID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ["#00a9ae"],
                    borderColor: ["#00a9ae"],
                    pointBorderColor: ["#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae"],
        ...
        var scatterChart = new Chart(scatterChartID, {
            ...
            data: {
                datasets: [{
                    ...
                    pointBorderColor: ["#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae"],
        ...
        var barChart = new Chart(barChartID, {
            type: 'bar',
                data: {
                    ...
                    datasets: [{
                        label: 'Series A',
                        backgroundColor: ["#00a9ae", "#00a9ae", "#00a9ae", "#00a9ae", "#00a9ae", "#00a9ae", "#00a9ae"],
                        borderColor: ["#00a9ae", "#00a9ae", "#00a9ae", "#00a9ae", "#00a9ae", "#00a9ae", "#00a9ae"],
                        borderWidth: 1,
        ...
        var multiAxisBarChart = new Chart(multiAxisBarChartID, {
            type: 'bar',
                data: {
                    ...
                    datasets: [{
                        label: 'Series A',
                        backgroundColor: ["#00a9ae","#43d187","#f2f3f7","#f9616d","#f7bb4d","#3d9bfb","#141d46"],
                        yAxisID: 'y-axis-1',
        ...
        var datasetArea = new Chart(datasetAreaID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ["rgba(80,111,228,0.5)"],
                    borderColor: ["#00a9ae"],
                    pointBorderColor: ["#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae"],
                    pointBackgroundColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBorderWidth: 2,                                               
        ...
        var radarArea = new Chart(radarAreaID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderColor: ["#00a9ae"],
                    pointBorderColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBackgroundColor: ["#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae","#00a9ae"],
                    pointBorderWidth: 1,
        ...
        var doughnutChart = new Chart(doughnutChartID, {
            ...
            data: {
                datasets: [{
                    ...
                    backgroundColor: ["#00a9ae","#43d187","#f2f3f7"],
                    label: 'Dataset 1'
                }],
