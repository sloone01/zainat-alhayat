                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-6 col-xl-1">
                            <p class="piety-data-attributes text-center my-3">
                                <span data-peity='{ "fill": ["#00a9ae", "#f2f3f7"],  "innerRadius": 22, "radius": 28 }'>3/7</span>
                            </p>
                        </div>
            ...
            <div class="card crm-project-box m-b-30">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-6 col-xl-1">
                            <p class="piety-data-attributes text-center my-3">
                                <span data-peity='{ "fill": ["#00a9ae", "#f2f3f7"],  "innerRadius": 22, "radius": 28 }'>4/7</span>
                            </p>
                        </div>
                        <div class="col-12 col-lg-6 col-xl-3">
            ...
            <div class="card crm-project-box m-b-30">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-6 col-xl-1">
                            <p class="piety-data-attributes text-center my-3">
                                <span data-peity='{ "fill": ["#00a9ae", "#f2f3f7"],  "innerRadius": 22, "radius": 28 }'>5/7</span>
                            </p>
                        </div>
                        <div class="col-12 col-lg-6 col-xl-3">
