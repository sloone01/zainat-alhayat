    ...
    <div class="row">
        <div class="col-md-6 col-lg-4">
            <div class="card m-b-30">
                ...
                <div class="card-body text-center">                                
                    <input class="knob" data-width="150" data-height="150" data-displayInput=false data-bgColor="#f2f3f7" data-fgcolor="#00a9ae" value="35">
                </div>
            </div>
        </div>    
        <!-- End col -->
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card m-b-30">
                ...
                <div class="card-body text-center">
                    <input class="knob" data-width="150" data-height="150" data-displayPrevious=true data-bgColor="#f2f3f7" data-fgColor="#00a9ae" data-skin="tron" data-cursor=true value="75" data-thickness=".2">
                </div>                            
            </div>
        </div>
        <!-- End col -->
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card m-b-30">
                ...
                <div class="card-body text-center">
                    <input class="knob" data-width="150" data-height="150" data-bgColor="#f2f3f7" data-fgColor="#00a9ae" data-thickness=".1" readonly value="22">
                </div>                            
            </div>
        </div>
        <!-- End col -->
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body text-center">
                    <div class="knob-superpose">
                        <div class="knob-hour">
                            <input class="knob hour" data-min="0" data-max="24" data-bgColor="#f2f3f7" data-fgColor="#00a9ae" data-displayInput=false data-width="150" data-height="150" data-thickness=".3">
                        </div>
